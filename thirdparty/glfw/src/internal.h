...
typedef EGLBoolean(APIENTRY* PFN_eglGetConfigAttrib)(EGLDisplay, EGLConfig,
                                                     EGLint, EGLint*);
typedef EGLBoolean(APIENTRY* PFN_eglGetConfigs)(EGLDisplay, EGLConfig*, EGLint,
                                                EGLint*);
...
typedef EGLSurface(APIENTRY* PFN_eglCreateWindowSurface)(EGLDisplay, EGLConfig,
                                                         EGLNativeWindowType,
                                                         const EGLint*);
...
typedef EGLDisplay(APIENTRY* PFNEGLGETPLATFORMDISPLAYEXTPROC)(EGLenum, void*,
                                                              const EGLint*);
