...
typedef void (*GLFWtrayclickfun)(GLFWwindow*, int, unsigned int);
 ...
 *  @ingroup input
 */
typedef void (* GLFWdropfun)(GLFWwindow*,int,const wchar_t*[]);
...
GLFWAPI GLFWtrayclickfun glfwSetTrayClickCallback(GLFWwindow* window, GLFWtrayclickfun callback);
